...
<span class="caption">Listing 8-1: Erstellen eines neuen, leeren Vektors zur
...
in spitzen Klammern angegeben. In Listing 8-1 haben wir Rust gesagt, dass der
...
enthält. Listing 8-2 erzeugt einen neuen `Vec<i32>`, der die Werte `1`, `2`
...
<span class="caption">Listing 8-2: Erstellen eines neuen Vektors mit
Werten</span>
...
Methode `push` verwenden, wie in Listing 8-3 zu sehen ist.
...
<span class="caption">Listing 8-3: Verwenden der Methode `push` zum
...
Listing 8-4 zeigt beide Zugriffsmethoden auf einen Wert in einem Vektor,
...
<span class="caption">Listing 8-4: Verwenden der Indexierungssyntax und der
...
<span class="caption">Listing 8-5: Versuch, auf das Element mit Index 100 in
...
<span class="caption">Listing 8-6: Versuch, ein Element zu einem Vektor
...
Element zur gleichen Zeit zuzugreifen. Listing 8-7 zeigt, wie man eine
...
<span class="caption">Listing 8-8: Iterieren über veränderbare Referenzen
...
Gültigkeitsbereich verlässt, wie in Listing 8-10 kommentiert wird.
...
<span class="caption">Listing 8-10: Zeigt, wo der Vektor und seine Elemente
