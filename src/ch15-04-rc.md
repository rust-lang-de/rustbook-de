...
<img alt="Zwei Listen, die sich das Eigentum an einer dritten Liste teilen"
src="img/trpl15-03.svg" class="center" />

<span class="caption">Abbildung 15-3: Zwei Listen `b` und `c` teilen sich das
Eigentum an einer dritten Liste `a`</span>
...
<span class="caption">Listing 15-17: Dies zeigt, dass wir mit `Box<T>` keine
zwei Listen haben dürfen, die versuchen, das Eigentum an einer dritten Liste zu
teilen</span>

Beim Versuch, den Programmcode zu kompilieren, erhalten wir folgende
Fehlermeldung:
...
<span class="caption">Listing 15-18: Eine Definition von `List`, die `Rc<T>`
verwendet</span>
...
<span class="caption">Listing 15-19: Den Referenzzähler ausgeben</span>
