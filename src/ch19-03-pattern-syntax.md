...
Variablen der Fall ist. In Listing 19-11 deklarieren wir eine Variable mit
...
<span class="caption">Listing 19-11: Ein `match`-Ausdruck mit einem Zweig,
...
Listing 19-12 zeigt eine Struktur `Point` mit zwei Feldern, `x` und `y`, die
...
<span class="caption">Listing 19-13: Destrukturieren von Strukturfeldern mit
...
<span class="caption">Listing 19-14: Destrukturieren und Abgleichen literaler
...
Wir haben in diesem Buch bereits Aufzählungen destrukturiert (z.B. Listing
...
verwenden wir in Listing 19-15 die Aufzählung `Message` aus Listing 6-2 und
...
Kurznotation, wie wir es in Listing 19-13 getan haben.
...
Elementen! Zum Beispiel können wir den Code in Listing 19-15 umstrukturieren,
um RGB- und HSV-Farben in der `ChangeColor`-Nachricht zu unterstützen, wie in
Listing 19-16 gezeigt.
...
<span class="caption">Listing 19-17: Verwenden von `_` in einer
...
<span class="caption">Listing 19-18: Das Verwenden eines Unterstrichs
...
<span class="caption">Listing 19-19: Ignorieren mehrerer Teile eines
Tupels</span>
...
mit einem Unterstrich beginnst. In Listing 19-20 erstellen wir zwei
...
<span class="caption">Listing 19-20: Beginnen eines Variablennamens mit einem
...
wird uns Listing 19-21 einen Fehler liefern.
...
des Unterstrichs an sich bindet jedoch niemals einen Wert. Listing 19-22 wird
...
<span class="caption">Listing 19-22: Das Verwenden eines Unterstrichs bindet
den Wert nicht</span>
...
explizit zugeordnet haben. In Listing 19-23 haben wir eine Struktur `Point`,
...
<span class="caption">Listing 19-23: Ignorieren aller Felder eines `Point`
...
Die Syntax `..` wird auf so viele Werte wie nötig erweitert. Listing 19-24
...
<span class="caption">Listing 19-24: Nur den ersten und letzten Wert in einem
...
uns Rust einen Fehler. Listing 19-25 zeigt ein Beispiel für die mehrdeutige
...
<span class="caption">Listing 19-25: Ein Versuch, `..` auf mehrdeutige Weise
zu verwenden</span>
...
<span class="caption">Listing 19-26: Hinzufügen einer Abgleichsbedingung zu
einem Muster</span>
...
Als wir Listing 19-11 besprochen haben, haben wir erwähnt, dass wir zur
...
dass wir nicht gegen den Wert der äußeren Variable testen konnten. Listing
...
<span class="caption">Listing 19-27: Verwenden einer Abgleichsbedingung zum
...
Listing 19-28 zeigt den Vorrang der Kombination einer Abgleichsbedingung mit
...
<span class="caption">Listing 19-28: Kombinieren mehrerer Muster mit einer
...
<span class="caption">Listing 19-29: Verwenden von `@`, um an einen Wert in
